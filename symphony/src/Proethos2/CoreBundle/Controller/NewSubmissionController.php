...
// Software. If not, see
// https://github.com/bireme/proethos2/blob/master/LIC
        ...
        if($this->getRequest()->isMethod('POST')) {
            ...
            if(isset($post_data['new-activity'])) {
                ...
                if (isset($post_data['form-data'])) {
                    ...
                    $submission->setStudySubjectOther($post_data['other-study-subject']);
            ...
            // checking required files
            $required_fields = array('study-design','data-collection-tools','data-collection-procedure','research-area-and-period', 'primary-outcome');
...
//                        }
                    ...
                    if($protocol->getMonitoringAction()) {
                        ...
                        $message = \Swift_Message::newInstance()
                        ->setSubject("[REAMS] " . $mail_translator->trans("A new protocol has been submitted."))
                        ->setFrom($util->getConfiguration('committee.email'))
                        ->setTo($secretaries_emails)
                        ->setBody(
                            $body
