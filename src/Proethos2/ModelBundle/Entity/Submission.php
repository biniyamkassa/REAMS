...
class Submission extends Base
{
    ...
    /**
     * Set studySubjectOther
     *
     * @param string $studySubjectOther
     *
     * @return Submission
     */
    public function setStudySubjectOther($studySubjectOther)
    {
        $this->study_subject_other = $studySubjectOther;

        return $this;
    }

    /**
     * Get studySubjectOther
     *
     * @return string
     */
    public function getStudySubjectOther()
    {
        return $this->study_subject_other;
    }
}
